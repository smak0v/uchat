...
static void add_user_box_to_gui(json_object *jobj, t_glade *g) {
    ...
    // json_object *j_username = json_object_object_get(jobj, "username");
    ...
    build_user_box(user_box, l_id);
    gtk_box_pack_start(GTK_BOX(g->box8), user_box, TRUE, TRUE, 0);
